...
local has_navigator, nav = pcall(require, "absaudio/navigator")
    -- manifest/config/downloader/progress removed: handlers live in book_detail.lua
...
-- Download/delete/ebook-open handlers removed (Issue #26)
-- After PR #22 self-contained refactor, these methods live exclusively in
-- BookDetailView (book_detail.lua). Library browser is navigation-only.
