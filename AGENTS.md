...
|------|------|------|----------|
| 2026-06-10 | generic | [fix-dashboard-detail-view-missing-action-buttons_log.md](docs/devlog/20260610-fix-dashboard-detail-view-missing-action-buttons_log.md) | Dashboard→detail now matches library→detail; wired on_download/on_delete/on_open_ebook callbacks + enriched item data from manifest; added 3 handler methods to DashboardView; 322 tests pass |
