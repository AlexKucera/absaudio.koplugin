...
package.loaded["config"] = {
    ...
    default_download_dir = function() return "/tmp/test/absaudio_books" end,
}
...
run_test("addToMainMenu creates absaudio menu with Open dashboard and Settings", function()
    ...
    mock.assert_equals(#menu_items.absaudio.sub_item_table, 3, "should have 3 sub-items (dashboard, settings, audio probe)")
